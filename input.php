...
$s_fullname = $s_age = $s_address = $s_MSV='';
...
if (!empty($_POST)) {
	...
	if ($s_id != '') {
		//update
		$sql = "UPDATE student SET fullname = '$s_fullname', age = '$s_age', address = '$s_address', MSV ='$s_MSV'  WHERE id = '$s_id'";
	} else {
		//insert
		$sql = "INSERT INTO student(fullname, age, address, MSV) VALUES ('$s_fullname', '$s_age', '$s_address','$s_MSV')";
	}
